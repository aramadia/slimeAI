...
// Source File Name:   SlimeGame.DannoAI.java
...
public class DannoAI extends SlimeAI
{
    ...
    public void moveSlime()
    {
        ...
        if(super.ballVX == 0 && super.ballX == 800 || serveType != -1)
        {
            ...
            case 2: // '\002'
                ...
                if(super.ballVY == -3 && super.p2X != 800)
                    move(2);
                if(super.ballVY < -12 && super.p2Y != 0 && super.p2X >= c - 15)
                {
                    move(0);
                    return;
                }
        ...
        if(Math.abs(super.p2X - i) < j)
        {
            ...
            if(Math.abs(super.ballX - super.p2X) < 150 && super.ballY > 50 && super.ballY < 400 && Math.random() < 0.66600000000000004D)
                jump();
        }
