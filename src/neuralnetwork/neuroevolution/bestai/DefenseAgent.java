...
public class DefenseAgent extends SlimeAI implements Agent {
    ...
    public static final int NUM_INPUT_NODES = 11;
    ...
    private static final String SaveFile = "defenseai";
...
//		nn.randomizeWeights();
	...
	public double evaluateFitness(int precision) {
        ...
        DefenseAgent slimeAgent = new DefenseAgent();
        slimeAgent.load();
...
//        	}
	...
	public Agent mutate(double mutationRate) {
		...
		DefenseAgent a = new DefenseAgent();
...
//        		normalizeVelocity(p2YV),
    ...
    public static void main(String[] args) {
        ...
        DefenseAgent ai2 = new DefenseAgent();
        ai2.load();
        ...
        SlimeAI dannoAI2 = new DannoAI2();
        SlimeAI human = null;
        SlimeV2.determineVictor(true, SlimeV2.ServeSide.RIGHT, threeSwapSlimeAI, ai2, 5);
    }
